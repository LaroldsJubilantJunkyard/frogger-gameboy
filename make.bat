...
SET LCC_COMPILE_BASE=%GBDK_HOME%\bin\lcc -Iheaders/gen -Iheaders/default -I%HUGETRACKER_DIR% -Wa-l -Wl-m -Wl-j -DUSE_SFR_FOR_REG
...
%LCC_COMPILE_BASE% -Wm-yC -o dist/Frogger.gb !COMPILE_OBJECT_FILES!

endlocal

"lib/romusage" dist\Frogger.noi -a